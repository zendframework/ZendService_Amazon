 ...
 */
class SecurityGroupsTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->securitygroupsInstance = new Ec2\SecurityGroups(
            'access_key',
            'secret_access_key',
            null,
            $this->httpClient
    ...
    public function testDescribeMultipleSecruityGroups()
    {
        ...
        $return = $this->securitygroupsInstance->describe(['WebServers', 'RangedPortsBySource']);
